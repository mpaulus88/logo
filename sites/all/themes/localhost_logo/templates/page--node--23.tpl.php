   ...
   <div id="navigation">
    ...
    <img id="slide" src="<?php print base_path() . path_to_theme() .'/' ?>images/imgSlide.png" alt="Logopédie">
     <div id="content" class="column" role="main">
      ...
      <div id="stage">
      <h2>Vous voulez proposez un stage?</h2>
      <?php print $messages; ?>
      <div class="form" id="form_fiche"> 
      <?php
        module_load_include('inc', 'node', 'node.pages');
        $form = node_add('fiche_signaletique');
        $output = drupal_render($form);
        print render($output);
        ?>
      </div>
      <h2>Vous recherchez un stage?</h2>
      <div id="fiches_signalétique">
        <?php
          $block = module_invoke('views', 'block_view', 'fiches_stage-block');    
