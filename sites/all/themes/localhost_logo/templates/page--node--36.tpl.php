    ...
    <img id="slide" src="<?php print base_path() . path_to_theme() .'/' ?>images/imgSlide.png" alt="Logopédie">
     <div id="content" class="column" role="main">
      ...
      <?php print render($title_suffix); ?>
        ...
        <div id="recherche">
            <p id=intro>Cliquer sur les marqueurs pour obtenir de plus amples informations sur nos collaborations</p>
            <div id="gmap"></div>  
        <?php
            $block = module_invoke('views', 'block_view', 'recherche-block');    
